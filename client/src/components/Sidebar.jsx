    ...
    return (
        <aside className="sidebar">
            <nav>
                    ...
                    {activeMenu === "repository" && (
                        <div className="sidebar-submenu">
                            ...
                            <div
                                ...
                                onMouseEnter={() =>
                                    setActiveRepositorySession("2026-2027")
                                }
                            >
                                <span>Session 2026-2027</span>
                                <span>›</span>

                                {activeRepositorySession === "2026-2027" && (
                                    <div className="nested-submenu">

                                        <Link to="/repository?session=2026-2027&term=even">
                                            Even
                                        </Link>

                                        <Link to="/repository?session=2026-2027&term=odd">
                                            Odd
                                        </Link>
                ...
                <button
                    className={`sidebar-menu-button ${
                        window.location.pathname.startsWith("/student-forum-ai")
                            ? "sidebar-active-menu"
                            : ""
                    }`}
                >
                    ...
                    {activeMenu === "studentForum" && (
                        <div className="sidebar-submenu">
                            ...
                            <div
                                className="semester-option"
                                onMouseEnter={() =>
                                    setActiveStudentForumSession("2026-2027")
                                }
                            >
                                <span>Session 2026-2027</span>
                                <span>›</span>

                                {activeStudentForumSession === "2026-2027" && (
                                    <div className="nested-submenu">

                                        <Link to="/student-forum-ai?session=2026-2027&term=even">
                                            Even
                                        </Link>

                                        <Link to="/student-forum-ai?session=2026-2027&term=odd">
                                            Odd
                                        </Link>
